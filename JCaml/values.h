...
/* Error types are glorified strings */
typedef val_str_t val_error_v_t;
typedef val_str_t val_error_t;
...
val_t val_wrap_error_v(val_error_v_t* c);

val_error_t* val_unwrap_error(val_t x);
val_t val_wrap_error(val_error_t* c);
